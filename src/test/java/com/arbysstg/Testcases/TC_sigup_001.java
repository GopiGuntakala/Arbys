...
public class TC_sigup_001 extends BaseClass {
	...
	public void Signup() throws IOException, InterruptedException {
		...
		for(int i=1; i<=Xlutils.getRowCount(xlpath, "Sheet1"); i++) {
			...
			String email="stg"+RandomNum()+"@gmail.com";
